...
' Default tolerance that is passed as an optional value in the comparison functions
Private Const DefaultCompareTolerance As Double = 0.00001
...
Public Function Equal(ByVal left As Double, ByVal right As Double, _
    Optional ByVal tolerance As Double = DefaultCompareTolerance) As Boolean
...
Public Function IsEffectivelyZero(ByVal num As Double, Optional ByVal tolerance As Double = DefaultCompareTolerance) As Boolean
...
Public Function IsEffectivelyOne(ByVal num As Double, Optional ByVal tolerance As Double = DefaultCompareTolerance) As Boolean
